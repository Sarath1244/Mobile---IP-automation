...
public class Takeseat extends Baseclass {
		       ...
		       //     caps.setCapability(MobileCapabilityType.BROWSER_NAME, "Chrome");
			           ...
			           //  Login valid credentails 
			             ...
			             System.out.println("Login successfull !!");
			                  ...
			                  {
			            	  f13.getMessage();
			            	  test.log(LogStatus.FAIL,"username and password  empty verified ", "To open Screenshots : <a href=' "+ Baseclass.takeSnapShot()+ " ' target=\\\"_blank\\  >Click Here</a>");
